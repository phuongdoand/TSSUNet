...
from bin.dataset import SeqDataset_Mono, SeqDataset_BEND, SeqDataset_SE, SeqDataset_SE_BEND, bendability_ref_normed
...
# Create dataset
train_set = SeqDataset_BEND(train_seqs, train_labels, bendability_ref_normed)
val_set = SeqDataset_BEND(val_seqs, val_labels, bendability_ref_normed)
...
for thres in np.linspace(0.02, 0.03, num=10):
